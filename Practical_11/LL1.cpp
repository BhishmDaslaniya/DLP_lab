...
int main(int argc, char const *argv[])
{
    ...
    cout<<"[!] Here \'e\' for epsilon, $ used as end of string and any other symbol treated as terminals."<<endl;
    cout<<"[!] Here Capital letters used for Not terminal/Variable."<<endl; 
    cout<<"[!] If find any mistake according to this then exit and modify grammar and rerun it."<<endl; 
    cout<<endl;
...
// Not done myself just made few changes due to time constrains...
// source credit: https://github.com/batman-nair/LL-1-Parser